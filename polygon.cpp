...
Polygon :: Polygon()
{
	cout<<"Polygon constructor called.\n";
}
Polygon :: Polygon (string name_var, int num_sides_var):num_sides(num_sides_var),area(0),name(name_var)
{
	cout<<"Polygon constructor called.\n";
}
Polygon ::~Polygon()
...
{
	cout<<name<<" "<<num_sides<<"sides, area="<<area;
}

Triangle :: Triangle(double base_var,double height_var):Polygon("Triangle",3),base(base_var),height(height_var)
{
...
Square :: Square(double side_length_var):Polygon("Square",4),side_length(side_length_var)
{
